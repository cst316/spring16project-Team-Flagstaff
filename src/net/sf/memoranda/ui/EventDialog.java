...
public class EventDialog extends JDialog implements WindowListener {
  ...
  void jbInit() throws Exception {
    ...
    noRepeatRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        noRepeatRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0; 
    ...
    dailyRepeatRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        dailyRepeatRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0; 
    ...
    setStartDateB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        setStartDateB_actionPerformed(event);
      }
    });
    ...
    weeklyRepeatRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        weeklyRepeatRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0; 
    ...
    enableEndDateCB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        enableEndDateCB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 4; 
    ...
    setEndDateB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        setEndDateB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 6; 
    ...
    monthlyRepeatRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        monthlyRepeatRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0; 
    ...
    yearlyRepeatRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        yearlyRepeatRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0; 
  ...
  /**
   * Method yearlyRepeatRB_actionPerformed.
   * 
   * @param event
   */
  public void yearlyRepeatRB_actionPerformed(ActionEvent event) {
    disableElements();
  ...
  /**
   * Method monthlyRepeatRB_actionPerformed.
   * 
   * @param event
   */
  public void monthlyRepeatRB_actionPerformed(ActionEvent event) {
    disableElements();
  ...
  /**
   * Method dailyRepeatRB_actionPerformed.
   * 
   * @param event
   */
  public void dailyRepeatRB_actionPerformed(ActionEvent event) {
    disableElements();
  ...
  /**
   * Method weeklyRepeatRB_actionPerformed.
   * 
   * @param event
   */
  public void weeklyRepeatRB_actionPerformed(ActionEvent event) {
    disableElements();
  ...
  public void noRepeatRB_actionPerformed(ActionEvent event) {
    disableElements();
  }
  ...
  void setStartDateB_actionPerformed(ActionEvent event) {
  ...
  void setEndDateB_actionPerformed(ActionEvent event) {
  ...
  public void enableEndDateCB_actionPerformed(ActionEvent event) {
