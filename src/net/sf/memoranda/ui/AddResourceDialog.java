...
public class AddResourceDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    localFileRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        localFileRB_actionPerformed(event);
      }
    });
    ...
    inetShortcutRB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        inetShortcutRB_actionPerformed(event);
      }
    });
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
  ...
  void localFileRB_actionPerformed(ActionEvent event) {
    enableFields();
    checkOkEnabled();
    urlField.select(0, 0);
  ...
  void inetShortcutRB_actionPerformed(ActionEvent event) {
    enableFields();
    checkOkEnabled();
  ...
  void pathField_caretUpdate(CaretEvent event) {
    checkOkEnabled();
  }
  ...
  void urlField_caretUpdate(CaretEvent event) {
    checkOkEnabled();
  }
