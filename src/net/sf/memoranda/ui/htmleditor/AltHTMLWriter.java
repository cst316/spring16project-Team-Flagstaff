...
public class AltHTMLWriter extends AbstractWriter {
	...
	protected void emptyTag(Element elem) throws BadLocationException, IOException {
		...
		/*
		 * Find Bugs fix - Code Review Defect id = 002
		 * Code Review by ghgofort - 2/29/16
		 * 
		 * Added null check to AttributeSet attr before referencing 
		 */
		if(attr!=null) {
	...
	class OptionListModel extends DefaultListModel implements ListSelectionModel, Serializable {
		...
		/*
		 * Find Bugs Error fix.  Defect log #005 for 
		 * US-76 code review - ghgofort - 2/29/16
		 * 
		 * Duplicate class member from super class. Hides
		 * the super class member if this is in place.
		 */
