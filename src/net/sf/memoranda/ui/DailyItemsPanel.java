...
import net.sf.memoranda.IHistoryListener;
import net.sf.memoranda.INote;
import net.sf.memoranda.INoteList;
import net.sf.memoranda.INoteListener;
...
public class DailyItemsPanel extends JPanel {
  ...
  void jbInit() throws Exception {
    ...
    toggleButton.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        toggleButton_actionPerformed(event);
      }
    });
    ...
    alarmB.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent event) {
        alarmB_actionPerformed(event);
      }
    });
    alarmB.setIcon(new ImageIcon(
          net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/alarm.png")
    ));
    ...
    taskB.setIcon(new ImageIcon(
          net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/task.png")
    ));
  ...
  void toggleButton_actionPerformed(ActionEvent event) {
    if (expanded) {
      expanded = false;
  ...
  public void updateIndicators(CalendarDate date, ITaskList tl) {
    ...
    if (date.equals(CalendarDate.today())) {
      ...
      if (EventsScheduler.isEventScheduled()) {
        ...
        net.sf.memoranda.IEvent ev = EventsScheduler.getFirstScheduledEvent();
  ...
  public void selectPanel(String pan) {
    ...
    if (pan.equals("TASKS") && (tasksPanel.taskTable.getSelectedRow() > -1)) {
      ITask t = CurrentProject.getTaskList().getTask(
          tasksPanel.taskTable.getModel().getValueAt(tasksPanel.taskTable.getSelectedRow(), 
  ...
  void taskB_actionPerformed(ActionEvent event) {
    parentPanel.tasksB_actionPerformed(null);
  }

  void alarmB_actionPerformed(ActionEvent event) {
